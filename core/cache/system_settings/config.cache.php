<?php  return array (
  ...
  'emailsubject' => 'Подтверждение вашей регистрации',
  'enable_dragdrop' => '1',
  'enable_gravatar' => '1',
  'error_page' => '2',
  ...
  'forgot_login_email' => '<p>Привет [[+username]],</p>
<p>Запрос для сброса пароля был выслан. Если вы отправили это сообщение, вы можете перейти по этой ссылке и использовать этот пароль для входа в систему. Если вы не отправили этот запрос, пожалуйста, проигнорируйте это письмо.</p>
...
<p>Regards,<br />Site Administrator</p>',
  ...
  'formit.form_encryptkey' => 'modx5bc46aeb33a500.40411608',
  'formit.recaptcha_private_key' => '',
  'formit.recaptcha_public_key' => '',
  'formit.recaptcha_use_ssl' => '0',
  'formit.user_email' => 'evgenkarp01@ya.ru',
  'formit.user_name' => 'ewal',
  ...
  'friendly_alias_translit_class_path' => '/mnt/sites/ebha/core/components/translit/model/',
  ...
  'modx_charset' => 'UTF-8',
  'mxcalendars.tiny.buttons1' => 'undo,redo,selectall,pastetext,pasteword,charmap,separator,image,modxl
ink,unlink,media,separator,code,help',
  'mxcalendars.tiny.buttons2' => 'bold,italic,underline,strikethrough,sub,sup,separator,bullist,numlist
,outdent,indent,separator,justifyleft,justifycenter,justifyright,justi
fyfull',
  'mxcalendars.tiny.buttons3' => 'styleselect,formatselect,separator,styleprops',
  'mxcalendars.tiny.buttons4' => '',
  'mxcalendars.tiny.buttons5' => '',
  'mxcalendars.tiny.custom_plugins' => '',
  'mxcalendars.tiny.height' => '200',
  'mxcalendars.tiny.theme' => '',
  'mxcalendars.tiny.theme_advanced_blockformats' => '',
  'mxcalendars.tiny.theme_advanced_selectors' => '',
  'mxcalendars.tiny.width' => '95%',
  'mxcalendars.use_richtext' => '',
  'parser_class' => 'pdoParser',
  'parser_class_path' => '/mnt/sites/ebha/core/components/pdotools/model/pdotools/',
  'parser_recurse_uncacheable' => '1',
  'password_generated_length' => '8',
  'password_min_length' => '8',
  'pdoFetch.class' => 'pdotools.pdofetch',
  'pdofetch_class_path' => '/mnt/sites/ebha/core/components/pdotools/model/',
  'pdoTools.class' => 'pdotools.pdotools',
  'pdotools_class_path' => '/mnt/sites/ebha/core/components/pdotools/model/',
  'pdotools_elements_path' => '/mnt/sites/ebha/core/elements/',
  ...
  'phpthumbon.noimage' => '/mnt/sites/ebha/assets/components/phpthumbon/noimage.jpg',
  'phpthumbon.noimage_cache' => '/mnt/sites/ebha/assets/components/phpthumbon/cache/',
  ...
  'phpthumb_nohotlink_valid_domains' => 'ebha.ru',
  ...
  'phpthumb_nooffsitelink_valid_domains' => 'ebha.ru',
  ...
  'signupemail_message' => '<p>привет [[+uid]],</p>
    ...
    <p>Regards,<br />Site Administrator</p>',
  'site_name' => 'EBHA вебинары и удаленное обучение',
  'site_start' => '1',
  'site_status' => '1',
  ...
  'use_multibyte' => '1',
  'use_weblink_target' => '',
  'webpwdreminder_message' => '<p>Хай [[+uid]],</p>
  ...
  'websignupemail_message' => '<p>Ку-ку [[+uid]],</p>
