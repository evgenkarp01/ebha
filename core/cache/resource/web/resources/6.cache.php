...
<html lang="ru">
<head>
    <title>Битва кланов - EBHA вебинары и удаленное обучение</title>
<base href="[[!++site_url]]" />
<meta charset="UTF-8" />
        ...
        <div class="sign-up" title="Редактор данных"><a href="lichnyij-kabinet/">
            ...
            <div class="fl-index">
                <div class="col-pol-l storage">
                        <nav class="main-menu">
    <ul>
        <ul class=""><li class="first"><a href="xranilishhe.html" >Хранилище</a></li><li><a href="translation.html" >Трансляция</a></li><li class="last active"><a href="bitva-klanov.html" >Битва кланов</a></li></ul>
    </ul>
</nav>
                    <div class="storage--tile mt-in">
                        <div class="item">
                            <div class="img"><img src="img/video.png" alt=""></div>
                            <div class="ttl">
                                <p>Studio Vlog #6. Про налоги, отношения и Pussy Riot</p>
                            </div>
                            <a href=""></a>
                        </div>
                        <div class="item">
                ...
                <div class="col-pol-r resources">
                    ...
                    <div class="list-sources mt-in">
                        <ul class="storage--list">
                            <li><a href="">Договор такой-то от такого-то числа</a></li>
                            <li><a href="">Когда от милой моей долины поднимается пар 
                                и полдневное солнце стоит над непроницаемой 
                                чащей темного леса</a></li>
                            <li><a href="">Душа моя озарена неземной радостью, 
                                как эти чудесные </a></li>
                            <li><a href="">Когда от милой моей </a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script src="assets/site/js/custom.js"></script>
  ...
  'elementCache' => 
  array (
    '[[$head]]' => '<title>Битва кланов - EBHA вебинары и удаленное обучение</title>
<base href="[[!++site_url]]" />
<meta charset="UTF-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
