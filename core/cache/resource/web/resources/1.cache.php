<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Главная',
    'longtitle' => 'Идейные соображения высшего порядка, а также постоянный количественный',
    'description' => '',
    'alias' => 'index',
    'link_attributes' => '',
    'published' => 1,
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '<p>Идейные соображения высшего порядка, а также постоянный количественный рост и сфера нашей активности играет определяющее значение <br /> для приоретизации разума над эмоциями. Банальные, но неопровержимые выводы, а также представители современных социальных резервов, превозмогая сложившуюся непростую экономическую ситуацию, ограничены исключительно образом мышления.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 0,
    'searchable' => 1,
...
<html lang="ru">
<head>
    <title>Главная - EBHA вебинары и удаленное обучение</title>
<base href="[[!++site_url]]" />
<meta charset="UTF-8" />
...
<body>
    <div id="[[!+modx.user.id:isloggedin:is=`1`:then=`main-lk`:else=`main`]]">
       <div class="container index-oplet">
            [[!+modx.user.id:isloggedin:is=`1`:then=`[[!$headerLk]]`:else=`[[!$header]]`]]
            <div class="fl-index">
                <div class="col-pol-l">
                    [[!+modx.user.id:isloggedin:is=`1`:then=`<div class="opl-ind">[[!$mainMenu]]</div>`:else=``]]
                    <div class="r-context">
                        <div class="video">
                ...
                <div class="col-pol-r">
                    <div class="oplet [[!+modx.user.id:isloggedin:is=`1`:then=`ttl-vilet`]]">
                        <div class="flex description">
                            <div class="ttl">
                                <h1>Идейные соображения высшего порядка, а также постоянный количественный</h1>
                            </div>
                            <div class="txt">
                                <p>Идейные соображения высшего порядка, а также постоянный количественный рост и сфера нашей активности играет определяющее значение <br /> для приоретизации разума над эмоциями. Банальные, но неопровержимые выводы, а также представители современных социальных резервов, превозмогая сложившуюся непростую экономическую ситуацию, ограничены исключительно образом мышления.</p>
                            </div>
                            [[!+modx.user.id:isloggedin:isnot=`1`:then=`[[!$signinorup]]`]]
                        </div>
                    </div>
                </div>
            </div>
    ...
    [[!+modx.user.id:isloggedin:is=`1`:then=`[[!$footerLk]]`:else=`[[!$footer]]`]]
...
<script src="assets/site/js/custom.js"></script>
  ...
  'elementCache' => 
  array (
    '[[$head]]' => '<title>Главная - EBHA вебинары и удаленное обучение</title>
<base href="[[!++site_url]]" />
<meta charset="UTF-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<script src="assets/site/js/custom.js"></script>',
    ...
    '[[pdoMenu?
        ...
        ]]' => '<ul class=""><li class="first"><a href="xranilishhe.html" >Хранилище</a></li><li><a href="translation.html" >Трансляция</a></li><li class="last"><a href="bitva-klanov.html" >Битва кланов</a></li></ul>',
    '[[dateY]]' => '2018',
  ),
  'sourceCache' => 
  array (
    ...
    <ul>
      ...
      array (
        ...
        array (
          ...
          'category' => 1,
          'cache_type' => 0,
          'snippet' => '<div class="btn btn-wt">
    <a href="[[~8]]"><button>Войти</button></a>
    <p>или <a href="[[~7]]">создать аккаунт</a></p>
</div>',
          'locked' => false,
          'properties' => 
          array (
